...
MHR.register(
   ...
   class extends MHR.AbstractPage {
      ...
      async fillTestData(ev) {
         ...
         document.forms["buyer_onboarding_form"].elements["CompanyOrganizationID"].value =
            "VATES-B35664875";
         ...
         try {
            ...
            if (error.response?.data?.organizationIdentifier?.code == "validation_not_unique") {
               gotoPage("MessagePage", {
                  ...
                  details:
                     "If you want to modify your registration data, or have any doubts, please contact us at info@circuloos.eu",
                  level: "info",
               });
               return;
            }
